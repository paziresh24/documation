...
هر ابزارک به یک فایل با فرمت JSON با نام دلخواه نیاز دارد که اطلاعات مهمی از ابزارک را ارائه می دهد. این فایل باید در دایرکتوری پابلیک(هرجای که در اینترنت باز بشود) قرار داشته باشد.
